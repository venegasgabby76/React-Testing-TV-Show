...
// mock data is listed below, we basically just want this to minic what the starting page looks like in the app
...
test("seasons are in the drop down menu", async () => {
  ...
  // using userEvent to stimulate what would happen when the use actually clicks on the dropbox!
